...
<div data-aos="zoom-in-up" data-aos-delay="400" class="space-y-4">
    <div class="flex items-start">
        <div class="flex-shrink-0 mt-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-lock text-amber-400">
                <rect width="18" height="11" x="3" y="11" rx="2" ry="2"/>
                <path d="M7 11V7a5 5 0 0 1 10 0v4"/>
            </svg>
        </div>
        <div class="ml-3">
            <p class="text-white font-medium">Secure Login System</p>
            <p class="text-white/70 text-sm">Multi-layered authentication with encrypted credentials</p>
        </div>
    </div>

    <div class="flex items-start">
        <div class="flex-shrink-0 mt-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-shield-check text-amber-400">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10"/>
                <path d="m9 12 2 2 4-4"/>
            </svg>
        </div>
        <div class="ml-3">
            <p class="text-white font-medium">Authentication & Authorization</p>
            <p class="text-white/70 text-sm">Role-based access control with granular permissions</p>
        </div>
    </div>

    <div class="flex items-start">
        <div class="flex-shrink-0 mt-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-bot text-amber-400">
                <path d="M12 8V4H8"/>
        ...
        <div class="ml-3">
            <p class="text-white font-medium">CAPTCHA Integration</p>
            <p class="text-white/70 text-sm">Advanced bot protection and automated threat prevention</p>
        </div>
    </div>

    <div class="flex items-start">
        <div class="flex-shrink-0 mt-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-key text-amber-400">
        ...
        <div class="ml-3">
            <p class="text-white font-medium">Unique Algorithm Protection</p>
            <p class="text-white/70 text-sm">Proprietary password & employee ID hashing algorithm</p>
        </div>
    </div>

    <div class="flex items-start">
        <div class="flex-shrink-0 mt-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-timer text-amber-400">
        ...
        <div class="ml-3">
            <p class="text-white font-medium">Session Timeout Protection</p>
            <p class="text-white/70 text-sm">Automatic logout after inactivity for enhanced security</p>
        </div>
    </div>

    <div class="flex items-start">
        <div class="flex-shrink-0 mt-1">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-clipboard-list text-amber-400">
        ...
        <div class="ml-3">
            <p class="text-white font-medium">Comprehensive Login Logs</p>
            <p class="text-white/70 text-sm">Detailed audit trails with activity and session monitoring</p>
        </div>
    </div>
</div>
